...
import com.newgen.xj_app.R.raw;
...
public class CodeScanActivity extends Activity implements Callback{
...
//			this.setResult(RESULT_OK, resultIntent);
			Intent resultIntent = new Intent();
			resultIntent = new Intent(CodeScanActivity.this, LinkDetailActivity.class);
