...
public class SuggestionActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new ArtWaitDialog(SuggestionActivity.this,"تاپشۇرغان ئوتتۇرا");
			...
			public void handleMessage(Message msg){
				switch (msg.what) {
					case 1:
						if(dialog!=null)
							dialog.dismiss();
						Toast.makeText(SuggestionActivity.this, "مۇۋەپپەقىيەت", 5).show();
						finish();
					break;
					case 2:
						if(dialog!=null)
							dialog.dismiss();
						Toast.makeText(SuggestionActivity.this, "مەغلۇپ بولۇش", 5).show();
						break;
					default:
						break;	
				}
	...
	public void onClick(View v) {
		...
		if(v==back)
			...
			if(content==null||content.equals("")){
				Toast.makeText(SuggestionActivity.this, "意见不能为空", 5).show();
			}else{
				dialog.show();
