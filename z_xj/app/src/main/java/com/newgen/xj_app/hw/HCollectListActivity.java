...
import com.newgen.xj_app.detail.ww.EpaperArticleDetailActivity;
...
public class HCollectListActivity extends Activity implements IXListViewListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_collect_list_h);
		...
		adapter = new CollectListAdapter(HCollectListActivity.this, newsList,isNight);
	...
	private void initList() {
		...
		tempList = hleper.getNewsList(HCollectListActivity.this, startPage, size);
		...
		if(tempList!=null){
			if(tempList.size()>0){
				...
				MyToast.showToast(HCollectListActivity.this, "没有更多数据", 5);
		}else
			MyToast.showToast(HCollectListActivity.this, "没有更多数据", 5);
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			if(newsMix.getIsEpaper()==0){
				...
				case PublicValue.NEWS_STYLE_WORD:
					intent = new Intent(HCollectListActivity.this, NewsDetailActivity.class);
					intent.putExtra("newsObject", news);
					break;
				case PublicValue.NEWS_STYLE_IMG:
					intent = new Intent(HCollectListActivity.this,
							ImgNewsDetailActivity.class);
					break;
				case PublicValue.NEWS_STYLE_LINK: // 视频直播和超链url
					intent = new Intent(HCollectListActivity.this, LinkDetailActivity.class);
	...
	class itemLongClick implements OnItemLongClickListener{
		...
		public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
			...
			// TODO Auto-generated method stub
			dialog = new ArtAlertDialog(HCollectListActivity.this, "确定删除这条收藏？", "提示", "确定", "取消", new ArtAlertDialog.OnArtClickListener() {
				...
				public void okButtonClick() {
					...
					if(newsList.get(position-1).getIsEpaper()==0)
						hleper.deleteCollectNews(newsList.get(position-1).getNewsPub().getId(),
								newsList.get(position-1).getIsEpaper(),HCollectListActivity.this);
					else
