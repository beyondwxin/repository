...
import com.newgen.xj_app.detail.ww.ActiveDetailActivity;
...
public class HActiveActivity extends Activity implements IXListViewListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_active_h);
...
//		initCid();
		...
		adapter = new ActiveListAdapter(HActiveActivity.this, newsList,isNight);
	...
	class ListItemClick implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			if(active.getFlag()==0){
				Toast.makeText(HActiveActivity.this,
						"活动还未开始哦", 5).show();
			}else {
				Intent intent = new Intent(HActiveActivity.this, ActiveDetailActivity.class);
		...
		protected void onPostExecute(Integer result) {
			try {
				...
				case -1:
					break;
				case 0:
					MyToast.showToast(HActiveActivity.this, "没有更多数据", 3);
					break;
				}
				stopLoadOrRefresh();
