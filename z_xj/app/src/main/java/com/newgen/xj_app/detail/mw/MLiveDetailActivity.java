...
import com.newgen.fragment.mw.MChatFragmentItem;
import com.newgen.fragment.mw.MLiveFragmentItem;
...
public class MLiveDetailActivity extends FragmentActivity {
	
	ArrayList<Fragment> fragmentsList;
	FragmentTransaction fragmentTransaction;
	Button back;
	FontTextView textView_live, textView_chat,createtime_text;
	MongolTextView title_livedetile;
	ViewPager live_pager;
	MChatFragmentItem chatFragmentItem;
	MLiveFragmentItem liveFragmentItem;
	String title = null;
	String liveid = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_live_detail_m);
		...
		title_livedetile = (MongolTextView) findViewById(R.id.title_livedetile);
		...
		liveFragmentItem = new MLiveFragmentItem();
		chatFragmentItem = new MChatFragmentItem();
