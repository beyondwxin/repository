...
public class HChannelActivity extends Activity implements OnItemClickListener{
...
//	int size = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_channel_h);
		initView();
		initData();
		initLocationChannel();
...
//		Log.i("size", size + "");
	...
	private void initView() {
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				saveChannel();
				Intent intent = new Intent(HChannelActivity.this,
						HMainFragmentActivity.class);
	...
	private void initCategory() {
		try {
			Map<String, String> map = (Map<String, String>) SharedPreferencesTools
					.getValue(this, PublicValue.WORD_NEWS_CATEGORY_FILE_HW_ED);
	...
	private void saveChannel() {
		...
		SharedPreferencesTools.setValue(HChannelActivity.this, map,
