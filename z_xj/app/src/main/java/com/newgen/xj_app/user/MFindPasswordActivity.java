...
public class MFindPasswordActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_find_password_m);
	...
	private void initWight() {
		...
		header = (MongolTextView)findViewById(R.id.header);
		user_phone = (EditText)findViewById(R.id.user_phone);
		user_password = (EditText)findViewById(R.id.user_password);
		user_code = (EditText)findViewById(R.id.user_code);
		commit = (MongolTextView)findViewById(R.id.commit);
		...
		mHandler = new Handler(){
			...
			public void handleMessage(Message msg) {
				...
				case 1:
					...
					Toast.makeText(MFindPasswordActivity.this, result, Toast.LENGTH_SHORT)
							.show();
					break;
				case 2:
		...
		public void onClick(View v) {
			...
			if(v==back)
				...
				if(isMobileNO(phone)){
					...
					MyToast.showToast(MFindPasswordActivity.this, "请输入正确的手机号", 1);
	...
	private class FindPwdRegistTask extends AsyncTask<Object, Integer, Integer> {
		...
		protected void onPreExecute() {
			dialog = MyDialog.createLoadingDialog(MFindPasswordActivity.this,
					"正在提交，请稍后……");
			dialog.show();
		}
	...
	private void initText() {
		// TODO Auto-generated method stub
		header.setText("ᠮᠠᠷᠲᠠᠵᠤ ᠨᠢᠭᠤᠴᠠ ᠲᠡᠮᠳ᠋ᠡᠭ᠌");//忘记密码
		commit.setTextColor(Color.parseColor("#FFFFFF"));
		commit.setGravity(Gravity.CENTER_HORIZONTAL);
		commit.setText("ᠪᠠᠲᠤᠯᠠ");//确定
	}
