...
public class HNewsReviewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String isNightString = SharedPreferencesTools.getValue(HNewsReviewActivity.this, SharedPreferencesTools.KEY_NIGHT,
		...
		if(isNight)
			...
			setContentView(R.layout.activity_news_review_h);
