 ...
 * 
 */
public class HLinkDetailActivity extends Activity {
	...
	protected void onStart() {
		...
		browserBody.setWebChromeClient(new WebChromeClient() {
			...
			public View getVideoLoadingProgressView() {
				FrameLayout frameLayout = new FrameLayout(HLinkDetailActivity.this);
	...
	class Click implements View.OnClickListener {
		...
		public void onClick(View v) {
			if (v == back) {
				...
				share.showSharelink(false, null, HLinkDetailActivity.this, title,
						shareimg, url);
			}
