...
public class MNewsReviewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String isNightString = SharedPreferencesTools.getValue(MNewsReviewActivity.this, SharedPreferencesTools.KEY_NIGHT,
		...
		if(isNight)
			...
			setContentView(R.layout.activity_news_review_m);
