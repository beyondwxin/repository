...
import com.newgen.adapter.ServiceAAdapter;
...
public class OfficeHallActivity extends Activity implements OnItemClickListener{
	
	ImageView back;
	GridView gridview;
	boolean isFrist = true;
	ServiceAAdapter adapter;
	String jsonData;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new ServiceAAdapter(OfficeHallActivity.this, lifes);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		// TODO Auto-generated method stub
		Intent intent = new Intent(OfficeHallActivity.this, MServiceDetailActivity.class);
