...
public class HSettingActivity extends Activity {
	...
	private void initView() {
		// TODO Auto-generated method stub
		version = Tools.getVision(HSettingActivity.this);
		...
		// 推送初始化
		String isPush = SharedPreferencesTools.getValue(HSettingActivity.this,
	...
	class Click implements OnClickListener{
		...
		public void onClick(View v) {
			...
			if(v==back){
		        ...
		        PushManager.getInstance().initialize(HSettingActivity.this.getApplicationContext(), com.newgen.service.PushService.class);
		        // com.getui.demo.DemoIntentService 为第三方自定义的推送服务事件接收类
		        PushManager.getInstance().registerPushIntentService(HSettingActivity.this.getApplicationContext(), com.newgen.service.IntentService.class);
				pushOpen = true;
				SharedPreferencesTools
				.setValue(HSettingActivity.this,
						SharedPreferencesTools.KEY_PUSH_CTRL,
						pushOpen ? "true" : "false",
						SharedPreferencesTools.KEY_PUSH_CTRL);
				...
				PushManager.getInstance().stopService(HSettingActivity.this);
				pushOpen = false;
				SharedPreferencesTools
				.setValue(HSettingActivity.this,
						SharedPreferencesTools.KEY_PUSH_CTRL,
				...
				// 清理缓存
				dialog = new ArtAlertDialog(HSettingActivity.this, "بېكىتىلگەن بۇففىرنى ئۆچۈرۈش. بۇففىرنى ئۆچۈرۈش بارمۇ ؟", "بۇفېرلىق ساقلىغۇچ ئېنىقلاش", "ئېنىق", "ئەمەلدىن قالدۇرماق", new ArtAlertDialog.OnArtClickListener() {
					
					@Override
					public void okButtonClick() {
						// TODO Auto-generated method stub
						// 为用户体验效果，先清除部分提示清理完成，后台清除其他缓存
						manager.cleanFiles(HSettingActivity.this);

						Toast.makeText(HSettingActivity.this, "بۇفېرلىق ساقلىغۇچ ئېنىقلاش ، مۇۋەپپەقىيەت",
								Toast.LENGTH_SHORT).show();

						manager.cleanInternalCache(HSettingActivity.this);
						manager.cleanExternalCache(HSettingActivity.this);
					}
				...
				if(version.equals(PublicValue.lastVersion))
					Toast.makeText(HSettingActivity.this, "نۆۋەتتىكى ئەڭ يېڭى نەشىرى", 5).show();
				else
					Toast.makeText(HSettingActivity.this, "يېڭى نۇسخا", 5).show();
				
			}else if(v==about_us){
				Intent intent = new Intent(HSettingActivity.this,
		...
		new AlertDialog.Builder(this).setTitle("تېكىست خەت شەكلى")
				.setItems(items, new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						SharedPreferencesTools.setValue(HSettingActivity.this, map,
