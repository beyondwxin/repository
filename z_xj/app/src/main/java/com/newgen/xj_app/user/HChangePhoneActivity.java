...
public class HChangePhoneActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_change_phone_h);
		...
		handler = new Handler() {
			public void handleMessage(Message msg) {
				...
				case 4:
					...
					Toast.makeText(HChangePhoneActivity.this, result, Toast.LENGTH_SHORT)
							.show();
					break;
				default:
					break;
			...
			if (v == backBtn)
				...
				if(isMobileNO(newPhone.getText().toString())){
					...
					dialog = MyDialog.createLoadingDialog(
							HChangePhoneActivity.this, "数据提交中...");
					dialog.show();
				}
			}else if(v==get_code){
				...
				if(isMobileNO(phone)){
					...
					MyToast.showToast(HChangePhoneActivity.this, "يانفون نومۇرىنى كىرگۈزۈڭ", 1);
			}
		}
	}
    ...
    class UpdateThread extends Thread {
		...
		public void run() {
			...
			if (user == null) {
				...
				Tools.saveUserInfo(user, HChangePhoneActivity.this);
				data.putInt("ret", 1);
			}
