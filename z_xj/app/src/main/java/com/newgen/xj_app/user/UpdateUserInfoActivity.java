...
import com.newgen.xj_app.R.drawable;
	...
	class Click implements OnClickListener{
		...
		public void onClick(View v) {
			...
			if(v==back)
				...
				inputDialog = new ArtInputDialog(UpdateUserInfoActivity.this,"سىزنىڭ يېڭى ئىسىم كىرگۈزۈڭ", "ئېنىق", "ئەمەلدىن قالدۇرماق", new ArtInputDialog.OnInputClickListener() {
