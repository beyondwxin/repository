...
import com.newgen.adapter.HComplainListAdapter;
...
public class HComplainListActivity extends Activity implements IXListViewListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_complain_list_h);
		...
		add_complain.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(HComplainListActivity.this, 
						HAddComplainActivity.class);
				startActivity(intent);
			}
		});
		
		listView = (XListView)findViewById(R.id.listView);
		adapter = new HComplainListAdapter(HComplainListActivity.this, newsList);
		...
		protected void onPostExecute(Integer result) {
			try {
				...
				case -1:
					break;
				case 0:
					MyToast.showToast(HComplainListActivity.this, "没有更多数据", 3);
					break;
				}
				stopLoadOrRefresh();
