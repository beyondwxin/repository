...
public class HMessageActivity extends Activity implements IXListViewListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_message_h);
		...
		adapter = new PublicNewsAdapter(HMessageActivity.this, newsList,isNight);
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int position,
			...
			if (news.getNewsPubExt().getInfotype() == 3) {//推广
				if (news.getNewsPubExt().getUrl() != null
					...
					intent = new Intent(HMessageActivity.this, HNewsDetailActivity.class);
				}
			}else
				...
				case PublicValue.NEWS_STYLE_IMG:
					intent = new Intent(HMessageActivity.this,
							HImgNewsDetailActivity.class);
					break;
				case PublicValue.NEWS_STYLE_LINK: // 视频直播和超链url
					intent = new Intent(HMessageActivity.this, HLinkDetailActivity.class);
		...
		protected void onPostExecute(Integer result) {
			try {
				...
				case -1:
					break;
				case 0:
					MyToast.showToast(HMessageActivity.this, "تېخىمۇ كۆپ سانلىق مەلۇمات يوق", 3);
					break;
				}
				stopLoadOrRefresh();
