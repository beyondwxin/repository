...
import com.newgen.adapter.MLiveAdapter;
...
public class MLiveFragmentItem extends Fragment implements IXListViewListener{
...
//	Callback callback;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		adapter = new MLiveAdapter(getActivity(), newsList);
