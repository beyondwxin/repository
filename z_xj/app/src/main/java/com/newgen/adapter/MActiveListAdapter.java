...
public class MActiveListAdapter extends BaseAdapter{
	...
	public MActiveListAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			convertView = layoutInflater.inflate(R.layout.active_list_item_m, null);
			
			holder.title = (MongolTextView) convertView.findViewById(R.id.title);
			holder.activeType = (MongolTextView)convertView.findViewById(R.id.activeType);
			holder.activeFlag = (MongolTextView)convertView.findViewById(R.id.activeFlag);
		...
		holder.activeType.setTextColor(Color.parseColor("#FFFFFF"));
		holder.activeFlag.setTextSize(11);
		holder.activeType.setTextSize(11);
	...
	private static class ViewHolder {
		...
		private MongolTextView title,activeType,activeFlag;
