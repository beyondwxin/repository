...
public class ComplainListAdapter extends BaseAdapter{
	...
	public ComplainListAdapter(Context context,List<Complain> newsList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(0==complain.getState()){//未处理
			...
			holder.state.setText("بىر تەرەپ قىلىنمىغان");
		}else if(1==complain.getState()){//处理中
			holder.state.setTextColor(Color.GREEN);
			holder.state.setText("بىر تەرەپ قىلىش داۋامىد");
		}else{//已处理
			holder.state.setTextColor(Color.GRAY);
			holder.state.setText("بىر تەرەپ قىلىندى");
		}
